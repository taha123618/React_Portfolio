...
import { MyImage, Resume } from "../../../public";
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="flex flex-col gap-24 p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col justify-center gap-12">
            ...
            <p className="italic">{host?.developer.toUpperCase()}</p>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              {host?.about_description}
            </p>
            <a
              className="p-3 font-bold text-center text-white bg-black rounded-full cursor-pointer"
              // href={Resume}
              // target="_pdf"
            >
              Download Resume
            ...
            >
              <div className="flex flex-wrap gap-2">
                {skills?.map((skill, index) => (
                  <div
                    key={index}
                    className="p-2 text-sm text-white bg-black rounded cursor-pointer hover:bg-white hover:text-black"
                  >
                    {skill}
                  </div>
                ))}
